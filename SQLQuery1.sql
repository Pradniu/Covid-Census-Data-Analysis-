...
order by 1,2
--sum of total cases and total deathpercentage
...
SELECT location,population,date,MAX(total_cases) as HighestInfected,MAX((total_cases/population))*100 as InfectedPercentage
FROM [census ]..CovidDeaths
